...
public:
		...
		m_SquarePosition(0.0f)
	{
		...
		m_TextureShader.reset(Hazel::Shader::Create(flatColorShaderVertexSrc, flatColorShaderFragmentSrc));
		m_TextureShader.reset(Hazel::Shader::Create("assets/shaders/Texture.glsl"));

		m_Texture = Hazel::Texture2D::Create("./assets/textures/Checkerboard.jpg");
		m_TextureLogo = Hazel::Texture2D::Create("./assets/textures/xCloudLogoSquare.png");
	...
	{
		//HZ_TRACE("Delta Time: {0} seconds ( {1} ms)", ts.GetSeconds(), ts.GetMilliseconds());
